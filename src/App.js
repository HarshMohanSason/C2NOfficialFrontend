      ...
      <main>
        ...
        <section className="fifth-section-newsletter">
          <section className="first-row">
            ...
            <address>
              <form>
                <input type="text" class="newletter" placeholder="EMAIL ADDRESS" />
              </form>
            </address>
          </section>
        </section>
        ...
        <section className="sixth-section">
          ...
          <article className="right-area">
            ...
            <p>Stay cozy and stylish with premium hoodie. Made from ultra-soft cotton fleece, perfect for layering and everyday wear.</p>
            <button type="button" style={{backgroundColor:"black", color:"white", borderRadius:"5px"}}>LEARN MORE <FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></button>           
          </article>
        </section>
        ...
        <section className="seventh-section">
          <article className="left-area">
            ...
            <h4>****</h4>
            <p>Quality you can feel. It feels like something built ages ago,
before cheap plastic invaded our lives. Love it so far.</p>
            <p> --- Martin </p>
            <button type="button" style={{backgroundColor:"transparent", color:"black", borderRadius:"5px"}}>SHOP NUDGE <FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></button>           
          </article>
